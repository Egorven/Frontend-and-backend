...
const vapidKeys = {
    publicKey: 'BAQfMuK0E1G2tHMl6seFXcWUhIPTKhbMdRp4ShDgtRmLo430zvs6BPKLPq6g66eP0oojWGqTuRNK391S6irL-nE',
    privateKey: 'EXc_bqgcPMs8c1vM3Tf4IbBAjF3xiqQgiY1oE9typ34'
};
webpush.setVapidDetails(
    'mailto:ciegor@list.ru',
    vapidKeys.publicKey,
...
app.post('/snooze', (req, res) => {
    ...
    const reminderText = (req.body && typeof req.body.text === 'string')
        ? req.body.text.trim()
        : '';
    ...
    // Если напоминание ещё висит в памяти - отменяем предыдущий таймер.
    if (reminder) {
        clearTimeout(reminder.timeoutId);
    }

    const textToSend = reminder ? reminder.text : reminderText;
